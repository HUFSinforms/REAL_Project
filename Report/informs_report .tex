...
\begin{table}[]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{cccccccccccccc}
			...
			Date & \# of asset & \textbf{} & \begin{tabular}[c]{@{}c@{}}\# of assets \\ to invest\end{tabular} & \begin{tabular}[c]{@{}c@{}}Objective \\ Value ($\times 10^{-4}$)\end{tabular} & $r_{Txadj t}$ & $r_{opt t}$ & turnover & \textbf{} & \begin{tabular}[c]{@{}c@{}}Pre\\ -processing\end{tabular} & Step1 & Step2 & Step3 & Total \\
			\midrule
